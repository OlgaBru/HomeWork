...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //созд. пустой списочный массив объемом в 10 элементов:
        ArrayList<Reader> readers = new ArrayList<>();//вместо Reader[] readers = new Reader[10];
        FileUtil fileUtil = new FileUtil();

        fileUtil.restoreReadersList(); //м-д для считывания из файла списка читателей
        ...
        do {
            ...
            action = sc.nextInt();
            sc.nextLine(); //холостой, чтобы программа не пропускала след. вход
            ...
            switch (action) {
                ...
                case 2: {
                    ...
                    for (int i = 0; i < readers.size() - 1; i++) {
                        if (readers.get(i) != null && readers.get(i).number==rd.number) {
                            //даем книгу читателю
                            rd.takeBook();
        ...
        fileUtil.saveReadersList(readers); //м-д для сохранения списка читателей в файл
